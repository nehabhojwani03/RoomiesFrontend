...
//                     </View>
//                     <View style={{ width: 30, height: 40, marginHorizontal: -40, marginTop: 15 }}>
...
const Roommate1 = () => {
    ...
    const openWhatsApp = () => {
        const phoneNumber = '+91 8112270790'; // Replace with the specific phone number
