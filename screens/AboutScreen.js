            ...
            >
                ...
                <View style={styles.ngoImgContainer}>
                    <Image style={styles.ngoImg}
                        source={require('../assets/images/RoomiesLogo.png')}
                    />
                </View>
                ...
                <View>
                    <Text style={{
                        ...
                        Roomies is a platform that connects people who are looking for roommates and helps them build better relationships. It provides a variety of features such as roommate matching, managing chores etc. to help roommates communicate, coordinate, and collaborate.
                    ...
                    <Text style={{
                        ...
                        It is a valuable tool for roommates of all ages and backgrounds. It can help them save time and energy, communicate more effectively, and build stronger relationships.
                    </Text>
                    {/* <Text style={{
                        fontSize: 14,
                        fontWeight: '400',
